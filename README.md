...
Wodby boilerplates are ready-to-use starter projects for popular application
frameworks. When you create a project, Wodby can import the selected
boilerplate into a new GitHub or GitLab repository so you can start with a
working application instead of an empty repository.

Choose the boilerplate that matches your application. After Wodby imports it,
the new repository is yours to customize and develop normally.
...
| [Express.js](https://github.com/wodby/expressjs-boilerplate) | Node.js APIs and web applications built with Express | [`service-node`](https://github.com/wodby/service-node) | [`stack-node`](https://github.com/wodby/stack-node) |
...
| [HTML](https://github.com/wodby/html-boilerplate) | Dependency-free static websites | [`service-httpd`](https://github.com/wodby/service-httpd), [`service-nginx`](https://github.com/wodby/service-nginx) | [`stack-html`](https://github.com/wodby/stack-html) |
...
| [Next.js](https://github.com/wodby/nextjs-boilerplate) | Full-stack React applications built with Next.js | [`service-nextjs`](https://github.com/wodby/service-nextjs) | [`stack-nextjs`](https://github.com/wodby/stack-nextjs) |
